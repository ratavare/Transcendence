...
PageElement.onLoad = () => {
	...
	const skybox = loader.load([
		'static/images/skybox/right.png', // Right
		'static/images/skybox/left.png', // Left
		'static/images/skybox/top.png', // Top
		'static/images/skybox/bottom.png', // Bottom
		'static/images/skybox/front.png', // Front
		'static/images/skybox/back.png'  // Back
	]);
	scene.background = skybox;
	
	// Sphere
	const ballLoader = new THREE.TextureLoader();
	const ballTexture = ballLoader.load('static/images/skybox/grey-scale-sun.jpg');
	...
	function makeWall(x, y, z, dx, dy, dz)
	{
		...
		const colorMap = textureLoader.load('static/images/walls/colorMap.png');
		const normalMap = textureLoader.load('static/images/walls/normalMap.png');
		const aoMap = textureLoader.load('static/images/walls/aoMap.png');
		const metallicMap = textureLoader.load('static/images/walls/metallicMap.png');
		const roughnessMap = textureLoader.load('static/images/walls/roughnessMap.png');
		const heightMap = textureLoader.load('static/images/walls/heightMap.png');
