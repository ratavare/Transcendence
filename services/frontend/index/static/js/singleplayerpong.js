...
PageElement.onLoad = () => {
	...
	function makePaddle(x, y, z, dx, dy, dz, color) {
		...
		const colorMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_albedo.png"
		);
		const normalMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_normal-ogl.png"
		);
		const aoMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_ao.png"
		);
		const metallicMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_metallic.png"
		);
		const roughnessMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_roughness.png"
		);
		const heightMap = textureLoader.load(
			"static/images/paddles/red-scifi-metal_height.png"
		);
